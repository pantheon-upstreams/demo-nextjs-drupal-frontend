  ...
  return (
    <div className="min-h-screen">
      <article className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {/* Image left of content on desktop; stacked (image on top) on mobile */}
          ...
          <div className="lg:sticky lg:top-20">
            {event.heroImage ? (
              <Image
                ...
                width={event.heroImage.width || 1200}
                height={event.heroImage.height || 800}
                className="w-full h-auto max-w-sm mx-auto lg:max-w-none rounded-xl shadow-glow"
                priority
        ...
        <header className="mb-8">
          ...
          <div className="flex flex-wrap gap-2 mb-8">
            ...
            {/* Content */}
            <div className="space-card p-6 sm:p-8 lg:p-10">
          {event.body && (
            <div 
              className="drupal-content prose prose-lg max-w-none
                ...
                prose-code:text-foreground prose-code:bg-[var(--badge-bg)] prose-code:px-1.5 prose-code:py-0.5 prose-code:rounded prose-code:text-sm prose-code:before:content-[''] prose-code:after:content-['']
