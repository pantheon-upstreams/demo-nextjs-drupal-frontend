...
import { getAllArticlesFromDrupal, type Article } from '@/lib/drupal';
...
export default async function PostsPage() {
  ...
  try {
    ...
    debugInfo.url = `${process.env.NEXT_PUBLIC_DRUPAL_BASE_URL || 'http://localhost:8080'}/jsonapi/node/article`;
    ...
    error = err;
    debugInfo.errorType = err instanceof Error ? err.constructor.name : typeof err;
