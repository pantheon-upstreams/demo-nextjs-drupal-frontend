...
export default async function Home() {
  ...
  // Use the config hero image with a Pantheon brand fallback
  const heroImageUrl = config?.site?.heroImage || "/brand/hero.png";
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Hero Section — starts beneath the fixed header */}
        ...
        <section className="mb-12 md:mb-16 text-center">
          <div className="space-card p-6 md:p-8 max-w-4xl mx-auto">
            ...
            <p className="text-base md:text-lg text-muted leading-relaxed mb-4 md:mb-6">
              This is a production-ready starter kit that demonstrates the seamless integration between Drupal 11 and Next.js 16.
            ...
            <p className="text-base md:text-lg text-muted leading-relaxed mb-4 md:mb-6">
              It&rsquo;s also a demonstration of running a decoupled stack on <strong>Pantheon</strong>: the Drupal backend and the
              Next.js frontend are managed together with one WebOps workflow &mdash; GitHub-driven deploys, Multidev preview
              environments, the Dev &rarr; Test &rarr; Live pipeline, and a Global CDN &mdash; on Pantheon&rsquo;s managed Next.js hosting.
            </p>
            <p className="text-base md:text-lg text-muted leading-relaxed">
              ...
              that leverages Drupal&rsquo;s content management capabilities with Next.js&rsquo;s modern frontend framework.
            </p>
          </div>
        </section>
            ...
            <article className="grid md:grid-cols-2 gap-6 md:gap-8 space-card p-6 md:p-8">
              ...
              <div className="flex flex-col justify-center">
                ...
                <time className="text-muted text-sm robot-text mb-4">
                  {formatDate(featuredArticle.createdDate)}
                </time>
          ...
          <section className="lg:col-span-1">
            ...
            {events.length === 0 ? (
              ...
              <div className="space-y-4 flex flex-col">
                {events.map((event) => (
                  <article key={event.slug} className="space-card overflow-hidden hover:shadow-glow transition-all">
                    <div className="flex gap-4 p-4">
                      {/* Event image (portrait-friendly thumbnail) */}
                      <Link href={event.path} className="relative w-20 flex-shrink-0 aspect-[4/5] rounded overflow-hidden bg-card">
                        <ImageWithFallback
                      ...
                      <div className="flex-1 min-w-0 flex flex-col">
                        ...
                        <div className="space-y-1 text-sm text-muted robot-text mt-auto">
